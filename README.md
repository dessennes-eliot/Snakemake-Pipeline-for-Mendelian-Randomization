...
- GRAPPLEofNEW To install this package, you need to build it with '''R CMD build your/path/to/folder_of/GRAPPLEofNEW'''
Then in R, make 'install.packages("your/path/to/GRAPPLEofNEW_0.2.2.tar.gz"' 
- ieugwasr
- dplyr
- TwoSampleMR
- RadialMR
