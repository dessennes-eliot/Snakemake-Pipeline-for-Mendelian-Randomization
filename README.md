This code implements a Snakemake pipeline for performing Mendelian randomization analyses on Genome-Wide Association Studies (GWAS). This is a project conducted by the Institut du Thorax at Nantes.
